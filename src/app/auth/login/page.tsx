  ...
  return (
    <div className={`flex justify-center w-[100vw] h-[100vh] ${alumni.className}`}>
      <div className="sm:w-[50vw] flex flex-col items-center h-[100vh] w-[80vw]">
        <Link href='/'><Image src="/Logo.png" alt="Logo" width={120} height={80} className="pt-[70px]" /></Link>
        <h1 className="text-black text-[40px] font-bold block pt-12">Welcome back!</h1>
        <h2 className="text-[#949494] text-[26px] font-semibold block">Please enter your details to login.</h2>
        <form className="flex min-w-[320px] flex-col w-[29vw] pt-12" onSubmit={handleSubmit}>
          ...
          <div className="text-center mb-10">
            <h1 className="text-[20px] font-semibold">New here? 
              <span className="text-blue-600 underline">
                <Link href="signup"><button className="underline">Signup</button></Link>
              </span>
            </h1>
          </div>
        </form>
